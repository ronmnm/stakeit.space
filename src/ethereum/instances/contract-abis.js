export const abiToken = ["NuCypherToken", "v0.0.0", "0x4fE83213D56308330EC302a8BD641f1d0113A4Cc", [{
    "inputs": [{
...
export const abiEscrow = ["StakingEscrow", "v5.3.1", "0x33D28FCB3204b146eA8D5f059Ebef8679F992DEb", [{
    "inputs": [{
    ...
    "anonymous": false,
    "inputs": [{"indexed": false, "internalType": "uint256", "name": "reservedReward", "type": "uint256"}],
    "name": "Initialized",
    "type": "event"
}, {
    "anonymous": false,
    ...
    "inputs": [],
    "name": "adjudicator",
    "outputs": [{"internalType": "contract AdjudicatorInterface", "name": "", "type": "address"}],
    "stateMutability": "view",
    "type": "function"
}, {
    ...
    "inputs": [{"internalType": "address[]", "name": "_stakers", "type": "address[]"}, {
        "internalType": "uint256[]",
    ...
    "inputs": [{"internalType": "uint256", "name": "_index", "type": "uint256"}, {
        ...
        "name": "_value",
        "type": "uint256"
    }], "name": "depositAndIncrease", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [{"internalType": "address", "name": "_staker", "type": "address"}, {
        "internalType": "uint256",
        "name": "_value",
    ...
    "inputs": [{"internalType": "uint16", "name": "_periods", "type": "uint16"}, {
        "internalType": "uint256",
        "name": "_startIndex",
        "type": "uint256"
    ...
    "inputs": [{"internalType": "address", "name": "_staker", "type": "address"}],
    "name": "getFlags",
    "outputs": [{"internalType": "bool", "name": "windDown", "type": "bool"}, {
        "internalType": "bool",
        "name": "reStake",
        "type": "bool"
    ...
    "outputs": [{"internalType": "uint16", "name": "startPeriod", "type": "uint16"}, {
        "internalType": "uint16",
        "name": "endPeriod",
        "type": "uint16"
    }],
    ...
    "outputs": [{"internalType": "uint16", "name": "firstPeriod", "type": "uint16"}, {
        "internalType": "uint16",
        "name": "lastPeriod",
        "type": "uint16"
    ...
    "inputs": [{"internalType": "uint256", "name": "_reservedReward", "type": "uint256"}, {
        "internalType": "address",
        "name": "_sourceOfFunds",
        "type": "address"
    ...
    "inputs": [{"internalType": "uint256", "name": "_value", "type": "uint256"}, {
        ...
        "name": "_periods",
        "type": "uint16"
    }], "name": "lockAndCreate", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [{"internalType": "uint256", "name": "_index", "type": "uint256"}, {
        "internalType": "uint256",
        "name": "_value",
        "type": "uint256"
    }], "name": "lockAndIncrease", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [],
    ...
    "inputs": [{"internalType": "uint16", "name": "_lockReStakeUntilPeriod", "type": "uint16"}],
    "name": "lockReStake",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
    ...
    "inputs": [{"internalType": "uint256", "name": "_index1", "type": "uint256"}, {
        "internalType": "uint256",
        "name": "_index2",
        "type": "uint256"
    }], "name": "mergeStake", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [],
    ...
    "inputs": [],
    "name": "policyManager",
    "outputs": [{"internalType": "contract PolicyManagerInterface", "name": "", "type": "address"}],
    "stateMutability": "view",
    "type": "function"
}, {
    "inputs": [],
    ...
    "inputs": [{"internalType": "uint256", "name": "_index", "type": "uint256"}, {
        ...
        "name": "_periods",
        "type": "uint16"
    }], "name": "prolongStake", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [{"internalType": "address", "name": "_from", "type": "address"}, {
        ...
        "name": "",
        "type": "bytes"
    }], "name": "receiveApproval", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [],
    ...
    "inputs": [{"internalType": "contract AdjudicatorInterface", "name": "_adjudicator", "type": "address"}],
    "name": "setAdjudicator",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
}, {
    "inputs": [{"internalType": "contract PolicyManagerInterface", "name": "_policyManager", "type": "address"}],
    ...
    "inputs": [{"internalType": "contract WorkLockInterface", "name": "_workLock", "type": "address"}],
    "name": "setWorkLock",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
    ...
    "inputs": [{"internalType": "address", "name": "_staker", "type": "address"}, {
        ...
        "name": "_reward",
        "type": "uint256"
    }], "name": "slashStaker", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    ...
    "inputs": [],
    "name": "workLock",
    "outputs": [{"internalType": "contract WorkLockInterface", "name": "", "type": "address"}],
    "stateMutability": "view",
    "type": "function"
}]];

export const abiManager = ["PolicyManager", "v6.1.2", "0xA5F6118d5BDA1cB5156a199004C182a3a7DC4e59", [{
    "inputs": [{
...
export const abiWorklock = ["WorkLock", "v0.0.0", "0xe9778E69a961e64d3cdBB34CF6778281d34667c2", [{
    "inputs": [{
        "internalType": "contract NuCypherToken",
        "name": "_token",
        "type": "address"
    ...
    "inputs": [{"indexed": true, "internalType": "address", "name": "sender", "type": "address"}, {
        ...
        "name": "refundETH",
        "type": "uint256"
    }, {"indexed": false, "internalType": "uint256", "name": "completedWork", "type": "uint256"}],
    "name": "Refund",
    "type": "event"
}, {
    "anonymous": false,
    ...
    "inputs": [{"internalType": "address payable[]", "name": "_biddersForRefund", "type": "address[]"}],
    "name": "forceRefund",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
    ...
    "inputs": [{"internalType": "address", "name": "", "type": "address"}],
    "name": "workInfo",
    "outputs": [{"internalType": "uint256", "name": "depositedETH", "type": "uint256"}, {
        "internalType": "uint256",
        "name": "completedWork",
        "type": "uint256"
    ...
    "inputs": [{"internalType": "uint256", "name": "_completedWork", "type": "uint256"}, {
        "internalType": "uint256",
        "name": "_depositedETH",
        "type": "uint256"
    }],
